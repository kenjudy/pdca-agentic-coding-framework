...
- **Oracle:** [expected value's source — observable and independent of the code under test (a file, an HTTP response, a database row, an external tool), not re-derived from the same logic]
